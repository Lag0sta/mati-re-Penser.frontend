...
function TopicThread({ setIsModalOpen, setModalComponent, setAuthType, setIsNewComment, isNewComment, setMessageModalOpen, setErrorMessage, setResponseType, threadRef }: topicProps) {
