...
function NewComment({ setIsMessageModalOpen, setErrorMessage, setIsNewComment }: newTopicProps) {
    ...
    return (
        <div className="w-[78%] flex flex bg-gray-800  border-2 border-gray-800  rounded-md my-1 ">
