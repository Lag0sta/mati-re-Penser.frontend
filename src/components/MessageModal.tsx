...
function MessageModal({ successMessage, setSuccessMessage, errorMessage, setErrorMessage, setIsMessageModalOpen, setModalComponent, setIsModalOpen, modalComponent, authType }: messageModalProps) {
